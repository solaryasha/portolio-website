...
export default function Page() {
  ...
  //     <main className="container px-4 md:px-6 m-auto">
  ...
  //         <p className="text-xs text-gray-500 dark:text-gray-400">© {new Date().getFullYear()} solaryasha.dev. All rights reserved.</p>
